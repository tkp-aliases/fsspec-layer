...
lint-py:  ## lint python with ruff
	python -m ruff check fsspec_layer
	python -m ruff format --check fsspec_layer
...
fix-py:  ## autoformat python code with ruff
	python -m ruff check --fix fsspec_layer
	python -m ruff format fsspec_layer
...
test:  ## run python tests
	python -m pytest -v fsspec_layer/tests

coverage:  ## run tests and collect test coverage
	python -m pytest -v fsspec_layer/tests --cov=fsspec_layer --cov-report term-missing --cov-report xml
